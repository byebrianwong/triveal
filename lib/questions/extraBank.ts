/**
 * Expanded question bank — 450 hand-written questions added to grow the daily
 ...
 * alongside the evergreen topics. The most recent batch of 50 pulls back the
 * other way to even out the category mix: it feeds the thin categories
 * (literature, art, mythology, the human body) while keeping a pop-culture
 * share, since the practice picker steers away from repeating a category and a
 * lopsided bank makes that harder. Same shape and rules as the seed samples
 * (spec §2.2):
...
export const EXTRA_QUESTIONS: Question[] = [
  ...
  },
  {
    id: "tardigrade",
    answer: "Tardigrade",
    answerCanonical: "tardigrade",
    answerAliases: ["water bear", "moss piglet"],
    category: "Animals",
    difficulty: "hard",
    clues: [
      { position: 1, text: "Some have been exposed to the vacuum of open space, unprotected, and lived." },
      { position: 2, text: "Barely half a millimetre long, it can dry into a lifeless husk called a tun and revive years later when wetted." },
      { position: 3, text: "It shuffles through damp moss and lichen on eight stubby clawed legs, and has been found everywhere from Himalayan peaks to deep-sea trenches." },
      { position: 4, text: "The microscopic eight-legged survivor nicknamed for its resemblance to a tiny, plodding, aquatic bear." },
    ],
    decoys: [
      { text: "Dust mite", eliminatedByClue: 2 },
      { text: "Rotifer", eliminatedByClue: 3 },
    ],
  },
  {
    id: "manatee",
    answer: "Manatee",
    answerCanonical: "manatee",
    answerAliases: ["sea cow"],
    category: "Animals",
    difficulty: "easy",
    clues: [
      { position: 1, text: "Sailors squinting at it through the haze are blamed for the mermaid legend." },
      { position: 2, text: "It grazes for hours on seagrass, and its worn molars are replaced from the back of the jaw throughout its life." },
      { position: 3, text: "Slow and round, it drifts into Florida's warm springs each winter and too often carries propeller scars on its back." },
      { position: 4, text: "The gentle aquatic herbivore whose closest living relatives are elephants, nicknamed for the cattle it seems to graze like." },
    ],
    decoys: [
      { text: "Walrus", eliminatedByClue: 2 },
      { text: "Dugong", eliminatedByClue: 3 },
    ],
  },
  {
    id: "pangolin",
    answer: "Pangolin",
    answerCanonical: "pangolin",
    answerAliases: [],
    category: "Animals",
    difficulty: "medium",
    clues: [
      { position: 1, text: "It is the most trafficked wild mammal on Earth, and its armour is made of the same stuff as your fingernails." },
      { position: 2, text: "Toothless, it laps up ants and termites with a sticky tongue that can be longer than its body and anchors near its pelvis." },
      { position: 3, text: "Threatened, it curls into a ball of overlapping keratin scales so tight that even lions give up on it." },
      { position: 4, text: "The scaly, ant-eating mammal of Africa and Asia whose name comes from a Malay word meaning 'roller'." },
    ],
    decoys: [
      { text: "Armadillo", eliminatedByClue: 2 },
      { text: "Anteater", eliminatedByClue: 3 },
    ],
  },
  {
    id: "firefly",
    answer: "Firefly",
    answerCanonical: "firefly",
    answerAliases: ["lightning bug"],
    category: "Animals",
    difficulty: "easy",
    clues: [
    ...
    decoys: [
      ...
      { text: "Glow-worm", eliminatedByClue: 4 },
    ],
  },
  {
    id: "nitrogen",
    answer: "Nitrogen",
    answerCanonical: "nitrogen",
    answerAliases: [],
    category: "Science",
    difficulty: "easy",
    clues: [
    ...
    decoys: [
      { text: "Oxygen", eliminatedByClue: 1 },
      { text: "Carbon dioxide", eliminatedByClue: 2 },
    ],
  },
  {
    id: "tsunami",
    answer: "Tsunami",
    answerCanonical: "tsunami",
    answerAliases: [],
    category: "Science",
    difficulty: "easy",
    clues: [
      { position: 1, text: "Out in open ocean it can pass under a ship unnoticed, barely a foot high." },
      { position: 2, text: "The sea sometimes draws far back from the shore minutes before it lands, exposing the seabed like a sudden impossible low tide." },
      { position: 3, text: "Wind has nothing to do with it: the seafloor itself lurches in a quake, a landslide or an eruption, and the pulse crosses the Pacific at jetliner speed." },
      { position: 4, text: "The Japanese word for 'harbour wave' names the surge that struck the Indian Ocean in 2004 and Tōhoku in 2011." },
    ],
    decoys: [
      { text: "Hurricane", eliminatedByClue: 1 },
      { text: "Rogue wave", eliminatedByClue: 3 },
    ],
  },
  {
    id: "x-ray",
    answer: "X-ray",
    answerCanonical: "x ray",
    answerAliases: [],
    category: "Science",
    difficulty: "easy",
    clues: [
    ...
    decoys: [
      ...
      { text: "Ultrasound", eliminatedByClue: 4 },
    ],
  },
  {
    id: "caffeine",
    answer: "Caffeine",
    answerCanonical: "caffeine",
    answerAliases: [],
    category: "Science",
    difficulty: "easy",
    clues: [
      { position: 1, text: "The plants that make it are brewing an insecticide; your jolt is a side effect." },
      { position: 2, text: "It blocks adenosine, the molecule that piles up in your brain all day telling you that you are tired — so it hides sleepiness rather than adding energy." },
      { position: 3, text: "Half of a dose is still in you five hours later, which is why a late-afternoon cup quietly costs you an hour of sleep." },
      { position: 4, text: "The world's most widely used stimulant, found in coffee beans, tea leaves, cacao and cola nuts." },
    ],
    decoys: [
      { text: "Sugar", eliminatedByClue: 2 },
      { text: "Nicotine", eliminatedByClue: 4 },
    ],
  },
  {
    id: "hubble-space-telescope",
    answer: "Hubble Space Telescope",
    answerCanonical: "hubble space telescope",
    answerAliases: ["Hubble"],
    category: "Space",
    difficulty: "hard",
    clues: [
    ...
    decoys: [
      { text: "James Webb Space Telescope", eliminatedByClue: 2 },
      { text: "Kepler Space Telescope", eliminatedByClue: 3 },
    ],
  },
  {
    id: "voyager-1",
    answer: "Voyager 1",
    answerCanonical: "voyager 1",
    answerAliases: ["Voyager"],
    category: "Space",
    difficulty: "hard",
    clues: [
      { position: 1, text: "It carries a gold-plated record of whale song, greetings in 55 languages and Chuck Berry, in case anyone out there finds it." },
      { position: 2, text: "Launched in 1977, it slingshotted past Jupiter and Saturn, then turned around in 1990 to take the 'Pale Blue Dot' photograph of Earth." },
      { position: 3, text: "In 2012 it became the first human-made object to cross into interstellar space, still calling home on a transmitter dimmer than a fridge bulb." },
      { position: 4, text: "The more distant of NASA's twin probes of 1977, now over 24 billion km out — the farthest thing we have ever made." },
    ],
    decoys: [
      { text: "Pioneer 10", eliminatedByClue: 1 },
      { text: "New Horizons", eliminatedByClue: 2 },
    ],
  },
  {
    id: "bermuda-triangle",
    answer: "Bermuda Triangle",
    answerCanonical: "bermuda triangle",
    answerAliases: [],
    category: "Geography",
    difficulty: "easy",
    clues: [
      { position: 1, text: "Insurers charge not a penny extra to sail a ship through it." },
      { position: 2, text: "A 1964 magazine article coined its name and a 1974 bestseller made it famous; a librarian then checked the cases and found most had dull, documented explanations." },
      { position: 3, text: "The legend grew out of Flight 19, five Navy bombers that vanished on a training run out of Florida in 1945." },
      { position: 4, text: "The patch of Atlantic bounded roughly by Miami, Puerto Rico and a British island colony, blamed for swallowing ships and planes." },
    ],
    decoys: [
      { text: "Sargasso Sea", eliminatedByClue: 3 },
      { text: "Cape Horn", eliminatedByClue: 4 },
    ],
  },
  {
    id: "seoul",
    answer: "Seoul",
    answerCanonical: "seoul",
    answerAliases: [],
    category: "Cities",
    difficulty: "medium",
    clues: [
      { position: 1, text: "Its name is borrowed from nothing and means nothing else — it is simply the old word for 'capital'." },
      { position: 2, text: "Roughly half of the country's people live in its metropolitan area, well within artillery range of a fortified border." },
      { position: 3, text: "The Han River splits it, Gangnam sits on the south bank, and it hosted the Summer Games in 1988." },
      { position: 4, text: "The South Korean capital, home to Gyeongbokgung Palace and the headquarters of Samsung." },
    ],
    decoys: [
      { text: "Busan", eliminatedByClue: 2 },
      { text: "Tokyo", eliminatedByClue: 3 },
    ],
  },
  {
    id: "havana",
    answer: "Havana",
    answerCanonical: "havana",
    answerAliases: [],
    category: "Cities",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Cartagena", eliminatedByClue: 4 },
    ],
  },
  {
    id: "alcatraz",
    answer: "Alcatraz",
    answerCanonical: "alcatraz",
    answerAliases: ["Alcatraz Island"],
    category: "Landmarks",
    difficulty: "easy",
    clues: [
      { position: 1, text: "Its most famous escapees left papier-mâché dummy heads in their beds and were never seen again." },
      { position: 2, text: "Al Capone served more than four years here and reportedly played banjo in the inmate band." },
      { position: 3, text: "The federal prison shut in 1963 because salt air had eaten the buildings and running it cost about three times any other; Native American activists then occupied the island for 19 months." },
      { position: 4, text: "The island prison in San Francisco Bay, a cold mile and a quarter of current from the city." },
    ],
    decoys: [
      { text: "Sing Sing", eliminatedByClue: 3 },
      { text: "Rikers Island", eliminatedByClue: 4 },
    ],
  },
  {
    id: "hagia-sophia",
    answer: "Hagia Sophia",
    answerCanonical: "hagia sophia",
    answerAliases: [],
    category: "Landmarks",
    difficulty: "hard",
    clues: [
    ...
    decoys: [
      ...
      { text: "Blue Mosque", eliminatedByClue: 3 },
    ],
  },
  {
    id: "rosetta-stone",
    answer: "Rosetta Stone",
    answerCanonical: "rosetta stone",
    answerAliases: [],
    category: "History",
    difficulty: "medium",
    clues: [
      { position: 1, text: "The text on it is a dull tax decree; its whole value lies in being repeated." },
      { position: 2, text: "Napoleon's soldiers pulled it out of a fort wall in Egypt in 1799, the British carried it off two years later, and it has sat in the British Museum ever since." },
      { position: 3, text: "The same decree appears three times on it: in hieroglyphs, in everyday demotic script, and in ancient Greek." },
      { position: 4, text: "The dark slab that let Jean-François Champollion finally crack Egyptian hieroglyphs in 1822." },
    ],
    decoys: [
      { text: "Code of Hammurabi", eliminatedByClue: 2 },
      { text: "Dead Sea Scrolls", eliminatedByClue: 3 },
    ],
  },
  {
    id: "joan-of-arc",
    answer: "Joan of Arc",
    answerCanonical: "joan of arc",
    answerAliases: ["Jeanne d'Arc", "The Maid of Orléans"],
    category: "History",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Boudica", eliminatedByClue: 3 },
    ],
  },
  {
    id: "silk-road",
    answer: "Silk Road",
    answerCanonical: "silk road",
    answerAliases: [],
    category: "History",
    difficulty: "medium",
    clues: [
      { position: 1, text: "It was never one road, and the name was invented by a German geographer in 1877, long after the traffic had died." },
      { position: 2, text: "Almost nobody travelled its whole length; goods changed hands dozens of times between Chang'an and the Mediterranean." },
      { position: 3, text: "Paper, gunpowder, Buddhism and — by most accounts — the Black Death all moved along it beside the spices and horses." },
      { position: 4, text: "The network of caravan routes across Central Asia, named for the shimmering Chinese cargo that made it worth the journey." },
    ],
    decoys: [
      { text: "Grand Trunk Road", eliminatedByClue: 2 },
      { text: "Amber Road", eliminatedByClue: 4 },
    ],
  },
  {
    id: "pompeii",
    answer: "Pompeii",
    answerCanonical: "pompeii",
    answerAliases: [],
    category: "History",
    difficulty: "easy",
    clues: [
      { position: 1, text: "The bodies are long gone — the famous plaster figures are casts of the hollows the bodies left behind." },
      { position: 2, text: "Its walls still carry graffiti about elections, gladiators and who loved whom, frozen as of a single afternoon." },
      { position: 3, text: "Pliny the Younger watched from across the bay and wrote down the shape of the cloud: an umbrella pine." },
      { position: 4, text: "The Roman town buried under ash by Vesuvius in AD 79 and dug back out, astonishingly intact, from 1748 onwards." },
    ],
    decoys: [
      { text: "Herculaneum", eliminatedByClue: 1 },
      { text: "Ostia", eliminatedByClue: 4 },
    ],
  },
  {
    id: "dune",
    answer: "Dune",
    answerCanonical: "dune",
    answerAliases: [],
    category: "Movies",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Foundation", eliminatedByClue: 3 },
    ],
  },
  {
    id: "shawshank-redemption",
    answer: "The Shawshank Redemption",
    answerCanonical: "shawshank redemption",
    answerAliases: ["Shawshank"],
    category: "Movies",
    difficulty: "medium",
    clues: [
      { position: 1, text: "It flopped in cinemas, then became the highest-rated film on IMDb largely because a cable channel ran it on a loop." },
      { position: 2, text: "Stephen King never cashed the five-thousand-dollar cheque for the rights, and years later posted it back to the director, framed." },
      { position: 3, text: "Tim Robbins and Morgan Freeman play inmates whose friendship spans decades, held together by Freeman's narration and 'get busy living, or get busy dying'." },
      { position: 4, text: "Andy Dufresne crawls through a sewage pipe to freedom in this 1994 prison drama taken from a King novella." },
    ],
    decoys: [
      { text: "Cool Hand Luke", eliminatedByClue: 2 },
      { text: "The Green Mile", eliminatedByClue: 3 },
    ],
  },
  {
    id: "pixar",
    answer: "Pixar",
    answerCanonical: "pixar",
    answerAliases: [],
    category: "Movies",
    difficulty: "easy",
    clues: [
    ...
    decoys: [
      ...
      { text: "DreamWorks Animation", eliminatedByClue: 2 },
    ],
  },
  {
    id: "casablanca",
    answer: "Casablanca",
    answerCanonical: "casablanca",
    answerAliases: [],
    category: "Movies",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "The Maltese Falcon", eliminatedByClue: 3 },
    ],
  },
  {
    id: "star-trek",
    answer: "Star Trek",
    answerCanonical: "star trek",
    answerAliases: [],
    category: "Television",
    difficulty: "easy",
    clues: [
      { position: 1, text: "A prop from it — a little flip-open handset — is what the engineer behind the first mobile phone says he was trying to build." },
      { position: 2, text: "NBC cancelled the original series after three seasons in 1969; a letter-writing campaign and endless reruns turned the corpse into a franchise." },
      { position: 3, text: "It aired one of American television's first scripted interracial kisses, and Martin Luther King Jr talked Nichelle Nichols out of quitting the bridge crew." },
      { position: 4, text: "The USS Enterprise, Vulcans and 'live long and prosper' all come from this Gene Roddenberry creation." },
    ],
    decoys: [
      { text: "Battlestar Galactica", eliminatedByClue: 2 },
      { text: "Doctor Who", eliminatedByClue: 4 },
    ],
  },
  {
    id: "the-bear",
    answer: "The Bear",
    answerCanonical: "bear",
    answerAliases: [],
    category: "Television",
    difficulty: "medium",
    clues: [
      { position: 1, text: "One episode crams Jamie Lee Curtis, Bob Odenkirk and John Mulaney into a single catastrophic Christmas dinner." },
      { position: 2, text: "A fine-dining chef inherits his late brother's chaotic Chicago sandwich shop, where everyone answers 'Yes, chef'." },
      { position: 3, text: "Shot with handheld urgency, its seventh first-season episode plays out in one unbroken twenty-minute take." },
      { position: 4, text: "The FX kitchen drama starring Jeremy Allen White as Carmy, which the Emmys somehow class as a comedy." },
    ],
    decoys: [
      { text: "Beef", eliminatedByClue: 2 },
      { text: "The Menu", eliminatedByClue: 4 },
    ],
  },
  {
    id: "survivor",
    answer: "Survivor",
    answerCanonical: "survivor",
    answerAliases: [],
    category: "Television",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Big Brother", eliminatedByClue: 3 },
    ],
  },
  {
    id: "sza",
    ...
    difficulty: "medium",
    clues: [
      { position: 1, text: "Her stage name is built the same way RZA's and GZA's are, out of the Supreme Alphabet." },
      { position: 2, text: "Signed to Top Dawg Entertainment as its first female artist, she sang the hook on Kendrick Lamar's 'All the Stars'." },
      { position: 3, text: "Her 2017 debut Ctrl went five times platinum, and its long-delayed follow-up spent ten weeks at number one from December 2022." },
      { position: 4, text: "The New Jersey R&B singer behind 'Kill Bill' and 'Snooze', whose second album is titled SOS." },
    ],
    decoys: [
      { text: "Doja Cat", eliminatedByClue: 2 },
      { text: "Summer Walker", eliminatedByClue: 3 },
    ],
  },
  {
    id: "olivia-rodrigo",
    answer: "Olivia Rodrigo",
    answerCanonical: "olivia rodrigo",
    answerAliases: [],
    category: "Music",
    difficulty: "easy",
    clues: [
      { position: 1, text: "Two members of Paramore were added to one of her songs' credits after listeners noticed how much its chorus owed 'Misery Business'." },
      { position: 2, text: "Her debut single, written at seventeen about a driving test and a break-up, spent eight weeks at number one in 2021." },
      { position: 3, text: "She came up through a Disney+ High School Musical series before her first album swept her three Grammys, including Best New Artist." },
      { position: 4, text: "The pop-punk-leaning singer of 'drivers license' and 'good 4 u', whose albums are Sour and Guts." },
    ],
    decoys: [
      { text: "Sabrina Carpenter", eliminatedByClue: 2 },
      { text: "Billie Eilish", eliminatedByClue: 3 },
    ],
  },
  {
    id: "pink-floyd",
    answer: "Pink Floyd",
    answerCanonical: "pink floyd",
    answerAliases: [],
    category: "Music",
    difficulty: "medium",
    clues: [
      { position: 1, text: "Its founder left in 1968 with his mind in pieces, and the band spent the next thirty years writing about him." },
      { position: 2, text: "The Dark Side of the Moon — a prism on a black sleeve, the band's name nowhere on it — stayed on the Billboard chart for more than 900 weeks." },
      { position: 3, text: "A giant inflatable pig broke its moorings over Battersea Power Station during a cover shoot and drifted into Heathrow's flight paths." },
      { position: 4, text: "The English band behind The Wall and 'Comfortably Numb', named for two obscure Carolina bluesmen." },
    ],
    decoys: [
      { text: "Led Zeppelin", eliminatedByClue: 2 },
      { text: "The Who", eliminatedByClue: 3 },
    ],
  },
  {
    id: "aretha-franklin",
    answer: "Aretha Franklin",
    answerCanonical: "aretha franklin",
    answerAliases: ["Aretha"],
    category: "Music",
    difficulty: "medium",
    clues: [
      { position: 1, text: "The man who wrote her signature song heard her version and admitted the girl had just taken it away from him." },
      { position: 2, text: "A Detroit preacher's daughter, she cut her breakthrough at Muscle Shoals in 1967 and turned a plea into a demand spelled out letter by letter." },
      { position: 3, text: "She sang at three presidential inaugurations, and the state of Michigan declared her voice a natural resource." },
      { position: 4, text: "The Queen of Soul, the first woman inducted into the Rock and Roll Hall of Fame, who wanted a little R-E-S-P-E-C-T." },
    ],
    decoys: [
      { text: "Whitney Houston", eliminatedByClue: 1 },
      { text: "Tina Turner", eliminatedByClue: 2 },
    ],
  },
  {
    id: "call-of-duty",
    ...
    clues: [
      ...
      { position: 2, text: "It began in 2003 as a World War II shooter made by developers who had walked out on Medal of Honor, then marched forward into modern and future wars." },
      { position: 3, text: "Its yearly release rotates between studios, and a free battle-royale spin-off, Warzone, arrived in 2020." },
      { position: 4, text: "The Activision military shooter whose Captain Price and 'No Russian' mission are franchise landmarks." },
    ],
    decoys: [
      { text: "Battlefield", eliminatedByClue: 2 },
      { text: "Halo", eliminatedByClue: 4 },
    ],
  },
  {
    id: "stardew-valley",
    ...
    decoys: [
      { text: "Animal Crossing", eliminatedByClue: 2 },
      { text: "Harvest Moon", eliminatedByClue: 4 },
    ],
  },
  {
    id: "street-fighter",
    ...
    decoys: [
      ...
      { text: "Mortal Kombat", eliminatedByClue: 4 },
    ],
  },
  {
    id: "bluetooth",
    answer: "Bluetooth",
    answerCanonical: "bluetooth",
    answerAliases: [],
    category: "Technology",
    difficulty: "easy",
    clues: [
  ...
  },
  {
    ...
    answer: "GPS",
    answerCanonical: "gps",
    answerAliases: ["Global Positioning System"],
    category: "Technology",
    difficulty: "medium",
    clues: [
      { position: 1, text: "The clocks aboard its satellites are deliberately built to tick at the wrong rate, because relativity speeds them up once they are in orbit." },
      { position: 2, text: "The US military blurred the civilian signal on purpose until 2000, when President Clinton ordered the fuzzing switched off." },
      { position: 3, text: "A receiver needs four of the 31 satellites in view — three to place it, one to fix its own clock — and it only ever listens, never transmits." },
      { position: 4, text: "The American satellite navigation system your phone's blue dot rides on, alongside Europe's Galileo." },
    ],
    decoys: [
      { text: "Radar", eliminatedByClue: 3 },
      { text: "Galileo", eliminatedByClue: 4 },
    ],
  },
  {
    id: "rickroll",
    answer: "Rickroll",
    answerCanonical: "rickroll",
    answerAliases: ["Rickrolling", "Rickrolled"],
    category: "Internet",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Clickbait", eliminatedByClue: 4 },
    ],
  },
  {
    id: "ketchup",
    answer: "Ketchup",
    answerCanonical: "ketchup",
    answerAliases: ["Catsup"],
    category: "Food & Drink",
    difficulty: "easy",
    clues: [
      { position: 1, text: "It began in Asia as a fermented fish sauce, with no tomato anywhere near it." },
      { position: 2, text: "In the 1830s an American doctor sold it as a patent medicine, in pill form, for indigestion." },
      { position: 3, text: "Henry Heinz put his in clear glass in 1876 to prove there was no rotten filler in it, and leaned on vinegar to keep it." },
      { position: 4, text: "The thick tomato condiment that leaves the bottle at about 0.045 km/h and belongs on chips and burgers." },
    ],
    decoys: [
      { text: "Mustard", eliminatedByClue: 1 },
      { text: "Worcestershire sauce", eliminatedByClue: 4 },
    ],
  },
  {
    id: "croissant",
    answer: "Croissant",
    answerCanonical: "croissant",
    answerAliases: [],
    category: "Food & Drink",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Danish pastry", eliminatedByClue: 4 },
    ],
  },
  {
    id: "ramen",
    answer: "Ramen",
    answerCanonical: "ramen",
    answerAliases: [],
    category: "Food & Drink",
    difficulty: "easy",
    clues: [
      { position: 1, text: "A national poll once voted its instant version Japan's finest invention of the 20th century, ahead of karaoke." },
      { position: 2, text: "Momofuku Ando flash-fried the noodles in 1958 so they would keep for months and cook in three minutes; the cup followed in 1971." },
      { position: 3, text: "The restaurant version is fiercely regional — miso in Sapporo, milky pork-bone tonkotsu in Hakata — and the broth can simmer for a day." },
      { position: 4, text: "The Japanese wheat-noodle soup topped with chashu pork, a jammy egg and a sheet of nori, Chinese in origin despite the reputation." },
    ],
    decoys: [
      { text: "Udon", eliminatedByClue: 2 },
      { text: "Pho", eliminatedByClue: 4 },
    ],
  },
  {
    id: "olympic-games",
    answer: "Olympic Games",
    answerCanonical: "olympic games",
    answerAliases: ["Olympics"],
    category: "Sports",
    difficulty: "easy",
    clues: [
    ...
    decoys: [
      ...
      { text: "Commonwealth Games", eliminatedByClue: 2 },
    ],
  },
  {
    id: "sumo",
    answer: "Sumo",
    answerCanonical: "sumo",
    answerAliases: [],
    category: "Sports",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Judo", eliminatedByClue: 3 },
    ],
  },
  {
    id: "frankenstein",
    answer: "Frankenstein",
    answerCanonical: "frankenstein",
    answerAliases: [],
    category: "Literature",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "The Vampyre", eliminatedByClue: 3 },
    ],
  },
  {
    id: "great-gatsby",
    answer: "The Great Gatsby",
    answerCanonical: "great gatsby",
    answerAliases: [],
    category: "Literature",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Tender Is the Night", eliminatedByClue: 3 },
    ],
  },
  {
    id: "don-quixote",
    answer: "Don Quixote",
    answerCanonical: "don quixote",
    answerAliases: [],
    category: "Literature",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Robinson Crusoe", eliminatedByClue: 3 },
    ],
  },
  {
    id: "anubis",
    answer: "Anubis",
    answerCanonical: "anubis",
    answerAliases: [],
    category: "Mythology",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Horus", eliminatedByClue: 4 },
    ],
  },
  {
    id: "king-arthur",
    answer: "King Arthur",
    answerCanonical: "king arthur",
    answerAliases: [],
    category: "Mythology",
    difficulty: "easy",
    clues: [
    ...
    decoys: [
      ...
      { text: "Beowulf", eliminatedByClue: 3 },
    ],
  },
  {
    id: "frida-kahlo",
    answer: "Frida Kahlo",
    answerCanonical: "frida kahlo",
    answerAliases: [],
    category: "Art",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Diego Rivera", eliminatedByClue: 3 },
    ],
  },
  {
    id: "the-scream",
    answer: "The Scream",
    answerCanonical: "scream",
    answerAliases: [],
    category: "Art",
    difficulty: "medium",
    clues: [
      { position: 1, text: "The figure is not the one making the noise — the artist's diary has it clapping its hands over its ears against a shriek passing through nature." },
      { position: 2, text: "The blood-red sky may be a memory of Krakatoa's ash drifting over Norway years earlier." },
      { position: 3, text: "Its maker produced four versions in paint and pastel; two were stolen, in 1994 and 2004, and both came back." },
      { position: 4, text: "Edvard Munch's 1893 picture of a wavy skull-faced figure on a bridge, hands clamped to its head." },
    ],
    decoys: [
      { text: "The Starry Night", eliminatedByClue: 3 },
      { text: "The Kiss", eliminatedByClue: 4 },
    ],
  },
  {
    id: "liver",
    answer: "Liver",
    answerCanonical: "liver",
    answerAliases: [],
    category: "Human Body",
    difficulty: "medium",
    clues: [
    ...
    decoys: [
      ...
      { text: "Pancreas", eliminatedByClue: 4 },
    ],
  },
  {
    id: "skin",
    answer: "Skin",
    answerCanonical: "skin",
    answerAliases: [],
    category: "Human Body",
    difficulty: "easy",
    clues: [
